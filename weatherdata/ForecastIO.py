...
class ForecastIO(object):
    ...
    LANG_CHINESE='zh'
    EXCLUDE_DAILY='daily'
    EXCLUDE_HOURLY='hourly'
    EXCLUDE_CURRENTLY='currently'
    EXCLUDE_FLAGS='flags'
    EXCLUDE_MINUTELY='minutely'

    def __init__(self, apikey, extend=None, exclude=None, units=None, \
    lang=None, latitude=None, longitude=None, time_url=None):
        """
